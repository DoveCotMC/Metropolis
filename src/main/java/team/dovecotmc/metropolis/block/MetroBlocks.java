...
//    public static final Block BLOCK_TUNNEL_LIGHT_A = register("tunnel_light_a", new BlockTunnelLight(FabricBlockSettings.create().mapColor(MapColor.STONE_GRAY).nonOpaque()));
    ...
    public static final Block BLOCK_TRACKSIDE_SIGN_PILLAR = register("trackside_sign_pillar", new BlockSignalSignPillar(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(6.0f)));
