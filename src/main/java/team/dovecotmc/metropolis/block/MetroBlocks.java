...
//    public static final Block BLOCK_PIDS_1 = register("pids_1", new BlockMetroPIDSOne());
    ...
    // Platform Fence door
    public static final Block BLOCK_PSD_SMALL_DOOR_1 = register("psd_small_door_1", new BlockPSDSmallDoor(AbstractBlock.Settings.of(Material.METAL).strength(6.0f)));
    public static final Block BLOCK_PSD_SMALL_DOOR_2 = register("psd_small_door_2", new BlockPSDSmallDoor(AbstractBlock.Settings.of(Material.METAL).strength(6.0f)));
    public static final Block BLOCK_PSD_SMALL_FENCE_1 = register("psd_small_door_1", new BlockPSDSmallFence(AbstractBlock.Settings.of(Material.METAL).strength(6.0f)));
