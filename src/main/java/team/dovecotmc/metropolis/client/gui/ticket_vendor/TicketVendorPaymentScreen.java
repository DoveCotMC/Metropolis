...
public class TicketVendorPaymentScreen extends Screen {
    ...
    public TicketVendorPaymentScreen(BlockPos pos, TicketVendorPaymentData paymentData, Screen parentScreen) {
        super(new TranslatableText("gui.metropolis.ticket_vendor_payment.title"));
        this.pos = pos;
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.textRenderer.drawWithOutline(
                new TranslatableText("gui.metropolis.ticket_vendor_payment.title").asOrderedText(),
                intoTexturePosX(36),
                intoTexturePosY(12),
                0xFFFFFF,
                0x16161B,
        ...
        this.textRenderer.draw(
                matrices,
                new TranslatableText("gui.metropolis.ticket_vendor_payment.subtitle"),
                intoTexturePosX(34),
                intoTexturePosY(35),
                0x3F3F3F
        );
...
//        float scaleFactor = 8f / textRenderer.fontHeight;
        ...
        // Description price
        Text priceText = new TranslatableText("gui.metropolis.ticket_vendor_payment.price", paymentData.value);
//        scaleFactor = 1f;
        matrices.push();
        matrices.scale(scaleFactor, scaleFactor, scaleFactor);
        this.textRenderer.drawWithShadow(
        ...
        Text balanceText = new TranslatableText("gui.metropolis.ticket_vendor_payment.balance", balance);
        this.textRenderer.drawWithShadow(
                matrices,
                balanceText,
                intoTexturePosX(x0) / scaleFactor,
        ...
        matrices.push();
        matrices.scale(scaleFactor, scaleFactor, scaleFactor);
        Text continueText = new TranslatableText("gui.metropolis.ticket_vendor_payment.continue_button");
        textRenderer.draw(
                matrices,
                continueText,
