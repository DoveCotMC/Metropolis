...
public class TicketVendorScreen1 extends Screen {
    ...
    public TicketVendorScreen1(BlockPos pos, TicketVendorData data) {
        super(new TranslatableText("gui.metropolis.ticket_vendor_1.title"));
        this.pos = pos;
        this.data = data;
...
//        InventoryScreen
    ...
    protected void init() {
        ...
        this.mouseX = 0;
        this.mouseY = 0;
//        ButtonWidget buttonTest = new ButtonWidget(0, 0, 128, 20, new TranslatableText("metropolis.screen.ticket_machine.button.test"), button -> {
...
//        SliderWidget sliderWidget = new SliderWidget(0, 20, 128, 20, new LiteralText("wow"), 0.5) {
//            @Override
...
//        addDrawableChild(sliderWidget);
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        this.textRenderer.drawWithOutline(
                new TranslatableText("gui.metropolis.ticket_vendor.title").asOrderedText(),
                intoTexturePosX(36),
                intoTexturePosY(12),
                0xFFFFFF,
                0x16161B,
        ...
        this.textRenderer.draw(
                matrices,
                new TranslatableText("gui.metropolis.ticket_vendor_1.subtitle"),
                intoTexturePosX(48),
                intoTexturePosY(35),
                0x3F3F3F
        );
...
//        Text tip = new TranslatableText("gui.metropolis.ticket_vendor_1.tips_" + ((int) tipId % 3));
        String[] tips = new TranslatableText("gui.metropolis.ticket_vendor_1.tips").getString().split("\n");
...
//        scaleFactor = 10f / 14f;
        ...
        this.textRenderer.draw(
                matrices,
                new TranslatableText("gui.metropolis.ticket_vendor_1.button.buy_tickets"),
        ...
        this.textRenderer.draw(
                matrices,
                new TranslatableText("gui.metropolis.ticket_vendor_1.button.special"),
                intoTexturePosX(11) / scaleFactor,
        ...
        this.textRenderer.draw(
                matrices,
                new TranslatableText("gui.metropolis.ticket_vendor_1.button.refund"),
                intoTexturePosX(11) / scaleFactor,
...
//        scaleFactor = 14f / 14f;
        ...
        // Tickets/Green
        this.textRenderer.drawWithOutline(
                new TranslatableText("gui.metropolis.ticket_vendor_1.button.tickets").asOrderedText(),
        ...
        // Charge/Purple
        this.textRenderer.drawWithOutline(
                new TranslatableText("gui.metropolis.ticket_vendor_1.button.charge").asOrderedText(),
        ...
        this.textRenderer.drawWithOutline(
                new TranslatableText("gui.metropolis.ticket_vendor_1.button.buy_commuter").asOrderedText(),
        ...
        // Charge/Gray bottom
        this.textRenderer.drawWithOutline(
                new TranslatableText("gui.metropolis.ticket_vendor_1.button.buy_ic_card").asOrderedText(),
...
//            if (client.world.getBlockEntity(pos, MetroBlockEntities.TICKET_VENDOR_BLOCK_ENTITY).get().getStack(1).isEmpty()) {
        ...
        if (grayTopHovering || grayBottomHovering) {
            this.renderTooltip(matrices, new LiteralText("Coming s∞n..."), mouseX, mouseY);
        }
