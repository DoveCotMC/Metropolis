...
public class BumperBlockEntityRenderer implements BlockEntityRenderer<BlockEntityBumper> {
    @Override
    public void render(BlockEntityBumper entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
    ...
    @Override
    public boolean rendersOutsideBoundingBox(BlockEntityBumper blockEntity) {
    ...
    @Override
    public boolean isInRenderDistance(BlockEntityBumper blockEntity, Vec3d pos) {
