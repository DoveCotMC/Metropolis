...
public class CameraBlockEntityRenderer implements BlockEntityRenderer<BlockEntityCamera> {
    @Override
    public void render(BlockEntityCamera entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
    ...
    @Override
    public boolean rendersOutsideBoundingBox(BlockEntityCamera blockEntity) {
    ...
    @Override
    public boolean isInRenderDistance(BlockEntityCamera blockEntity, Vec3d pos) {
